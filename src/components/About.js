	...
	<header class="header clearfix">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="back_link">
						<a href="index.html" class="hde151" alt="back">Back To Cursus</a>
						<a href="index.html" class="hde152" alt="back">Back</a>
					</div>
					<div class="ml_item">
						<div class="main_logo main_logo15" id="logo">
							<a href="index.html"><img src="images/logo.svg" alt="logo" /></a>
							<a href="index.html"><img class="logo-inverse" src="images/ct_logo.svg" alt="logo" /></a>
						</div>				
					</div>				
						...
						<ul>				
							<li class="ui top right pointing dropdown">
								<a href="/" class="opts_account">
									<img src="images/hd_dp.jpg" alt="hddp" />
								</a>
								<div class="menu dropdown_account">
									<div class="channel_my">
										<div class="profile_link">
											<img src="images/hd_dp.jpg" alt="hddp2" />
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="title589 text-center">
							...
							<img class="line-title" src="images/line.svg" alt="line" />
						</div>
					</div>
		...
		<div class="_215zd5">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="story125">
							<img src="images/about/stroy_img.png" alt="stroy" />
						</div>
					</div>
		...
		<div class="_215xd5">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="jmio125">
							<img src="images/about/team.jpg" alt="team" />
						</div>
					</div>					
				</div>
			</div>
